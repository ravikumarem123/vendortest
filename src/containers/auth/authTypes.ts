...
export const LOGIN_PURPOSE = {
    ...
    SET_PASSWORD: 'SET_PASSWORD_AND_LOGIN',
    RESET_PASSWORD: 'RESET_PASSWORD_AND_LOGIN',
    SET_PASSWORD_AND_LOGIN: 'SET_PASSWORD_AND_LOGIN',
    RESET_PASSWORD_AND_LOGIN: 'RESET_PASSWORD_AND_LOGIN',
};
