...
const PaymentUTRCard: React.FC<IPros> = ({
    utrInfo,
    handleUTRCardClick,
    activeUTRCard,
    index,
    ...
    return (
        <div
            className={`utr-card-container ${
                utrInfo.utr === activeUTRCard ? 'active-utr-card' : ''
            }`}
            onClick={() => handleUTRCardClick(utrInfo.utr)}
        >
            <div className="utr-card-sno">{index + 1}</div>
            ...
            <div className="utr-card-data">
                <div className="utr-card-data-container">
                    <p>
                        {utrInfo.utr.length > 16
                            ? `${utrInfo.utr.slice(0, 15)}...`
                            : utrInfo.utr}
                    </p>
