            ...
            {showEmptyUtr ? (
                isPaymentAdviceLoading ? (
                    ...
                    <div className="empty-utr-container">
                        <img
                            className="empty-utr-img"
                            src={EmptyUTRImg}
                            alt="Empty UTR"
                        />
                        <p className="empty-utr-text">
                            {t('payment.emptyUtrtext')}
                        </p>
                    </div>
                )
            ) : (
                <>
                    <div className="advice-card-header">
                        <p
                            className="p-advice-head-text"
                            style={{ fontWeight: '600' }}
                        >
                            {t('payment.padvicesummary')}
                        </p>
                        <div className="p-advice-head-utr">
                            <p className="p-advice-utr">UTR {utr}</p>
                            <p className="p-advice-update-date">
                                {t('payment.settledon')} {settledDate}
                            </p>
                        </div>
                    </div>

                    <hr />
                    <PaymentAdviceTable items={items!} amount={totalAmount!} />
